...
mavlink20.MAV_PROTOCOL_CAPABILITY_PARAM_ENCODE_C_CAST = 2 // Parameter protocol uses C-cast of parameter values to set the
...
mavlink20.NAV_VTOL_LAND_OPTIONS_FW_DESCENT = 1 // Descend in fixed wing mode, transitioning to multicopter mode for
                        ...
                        // speed, etc.).
mavlink20.NAV_VTOL_LAND_OPTIONS_HOVER_DESCENT = 2 // Land in multicopter mode on reaching the landing co-ordinates (the
...
mavlink20.MAV_WINCH_STATUS_FLAG_ENUM_END = 1025 // 
...
MAV_CMD_REQUEST_MESSAGE.                  This contains MAVLink FTP
URIs for the component's general and peripherals metadata files along
with their CRCs (which can be used for file caching).         The
files must be hosted on the component, and may be xz compressed.
The general metadata file can be read to get the locations of
additional metadata files (COMP_METADATA_TYPE), which may be hosted
either on the vehicle or the Internet.         For more information
see: https://mavlink.io/en/services/component_information.html.
...
through 15, PageCount, Length and TimeStamp are not present and the
...
*/
mavlink20.messages.open_drone_id_system = function(target_system, target_component, id_or_mac, operator_location_type, classification_type, operator_latitude, operator_longitude, area_count, area_radius, area_ceiling, area_floor, category_eu, class_eu, operator_altitude_geo) {

    this.format = '<iifffHHBB20sBBBB';
    this.id = mavlink20.MAVLINK_MSG_ID_OPEN_DRONE_ID_SYSTEM;
    this.order_map = [7, 8, 9, 10, 11, 0, 1, 5, 6, 2, 3, 12, 13, 4];
    this.crc_extra = 150;
    this.name = 'OPEN_DRONE_ID_SYSTEM';

    this.fieldnames = ['target_system', 'target_component', 'id_or_mac', 'operator_location_type', 'classification_type', 'operator_latitude', 'operator_longitude', 'area_count', 'area_radius', 'area_ceiling', 'area_floor', 'category_eu', 'class_eu', 'operator_altitude_geo'];
...
mavlink20.messages.open_drone_id_system.prototype.pack = function(mav) {
    return mavlink20.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.operator_latitude, this.operator_longitude, this.area_ceiling, this.area_floor, this.operator_altitude_geo, this.area_count, this.area_radius, this.target_system, this.target_component, this.id_or_mac, this.operator_location_type, this.classification_type, this.category_eu, this.class_eu]));
}
...
mavlink20.map = {
        ...
        12904: { format: '<iifffHHBB20sBBBB', type: mavlink20.messages.open_drone_id_system, order_map: [7, 8, 9, 10, 11, 0, 1, 5, 6, 2, 3, 12, 13, 4], crc_extra: 150 },
